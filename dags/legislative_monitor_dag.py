...
def process_bills_task(**context):
    ...
    bills = context['task_instance'].xcom_pull(task_ids='fetch_bills')
...
def save_results_task(**context):
    ...
    processed_bills = context['task_instance'].xcom_pull(task_ids='process_bills')
    ...
    output_dir = "/tmp/legislative_monitor"
...
# Make tasks in output group run in parallel
